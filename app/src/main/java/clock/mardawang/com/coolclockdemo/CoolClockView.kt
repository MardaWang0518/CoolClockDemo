...
class CoolClockView @JvmOverloads constructor(
    ...
    private fun drawCenterInfo(canvas: Canvas) {
        Calendar.getInstance().run {
            ...
            mPaint.textSize = mHourR * 0.44f//字体大小根据「时圈」半径来计算
            mPaint.alpha = 255
            ...
            mPaint.textSize = mHourR * 0.26f//字体大小根据「时圈」半径来计算
            mPaint.alpha = 255
            mPaint.textAlign = Paint.Align.CENTER
